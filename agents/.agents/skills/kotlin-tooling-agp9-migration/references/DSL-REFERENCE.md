...
1. **Environment-specific behavior:** Use Gradle properties or runtime configuration.
1. **Different dependencies per build type:** Not possible in KMP library. Move to app module.
1. **Minification/ProGuard:** Only relevant in the application module.
