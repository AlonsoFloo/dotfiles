...
1. Migrate `kotlinOptions` to `compilerOptions`.
1. Upgrade Gradle to 9.1.0.
1. Upgrade AGP to 9.0.1+.
1. Migrate library plugins to `com.android.kotlin.multiplatform.library`.
1. Upgrade KGP to 2.3.0+ for best experience.
