...
1. **Suspend without parallelism** - Asynchronous method
1. **Advanced concurrency** - Parallel execution
...
1. Switch to "Task States" view
1. Look for Suspended states
1. Check suspension duration

### Navigate to code

1. Click task state (Running/Suspended)
1. Open Extended Detail
1. Click related method
1. Use "Open in Source Viewer"
...
1. **Start synchronous** - add async only when needed
1. **Use Instruments regularly** - catch issues early
1. **Name tasks** - easier debugging in Instruments
1. **Check suspension count** - reduce unnecessary awaits
1. **Avoid premature parallelism** - has costs
1. **Consider UX** - smooth > fast
1. **Batch actor work** - reduce contention
1. **Test on real devices** - simulators lie
1. **Monitor in production** - real usage patterns differ
...
1. Identify main thread hangs
1. Check task parallelism
1. Analyze actor queue sizes
1. Review suspension points
1. Navigate to problematic code
1. Apply optimizations
1. Re-profile to verify
