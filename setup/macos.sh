...
# ------------------------------------------------------------------------------
#
# This script configures macOS with a variety of settings that are optimized
# for a development environment. It's designed to be idempotent, so you can run
# it multiple times without causing any issues.
#
